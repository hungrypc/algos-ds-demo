...
Because the values of the array is like a pointer that points to indices (which we can treat as nodes). Since each number is 1..n (inclusive), then each value will have to point
